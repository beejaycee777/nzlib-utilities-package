...
namespace NZLib.Utilities.UI
{
    public sealed class MovingObject2D : MonoBehaviour
    {
        ...
        private void Start ()
        {
            _position.Limit.x = transform.localPosition.x - _distanceMax;
            _position.Limit.y = transform.localPosition.x + _distanceMax;
            _position.Limit.z = transform.localPosition.y - _distanceMax;
            _position.Limit.w = transform.localPosition.y + _distanceMax;
